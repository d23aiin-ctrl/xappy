...
def process_message(
    ...
    if not draft:
        ...
        if not report_type:
            return None, (
                "Hi there! 👋 I'm Xappy, your safety assistant.\n\n"
                "How can I help you today? You can:\n"
                "• Report a *near miss* or *incident*\n"
                "• Log a *spill* or *inspection*\n"
                "• Record a *shift handover* or *toolbox talk*\n\n"
                "Just tell me what happened or what you'd like to report!"
            ), None
        draft = {
