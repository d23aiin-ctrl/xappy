...
const socialLinks = [
  {
    href: 'https://www.linkedin.com/company/xappy/',
    icon: 'ri-linkedin-fill',
    label: 'LinkedIn',
  },
  {
    href: 'https://twitter.com/xappy',
    icon: 'ri-twitter-x-line',
    label: 'Twitter',
  },
  {
    href: 'https://www.facebook.com/xappy',
        ...
        <div className="footer-grid">
          ...
          <div className="footer-section">
            <div className="flex items-center gap-3 mb-4">
              <img
                src="/assets/images/xappy-logo.png"
                alt="Xappy - Igniting Connections"
                className="h-14 w-auto object-contain bg-white rounded-lg p-2"
              />
            </div>
            <p className="text-white/70 leading-relaxed mb-4">
              The AI-first customer experience platform for modern businesses. Automate, personalize, and scale customer interactions across channels.
            </p>
