"""
XAPPY Property Incident Report Details Model

Extended details for safety incident initial reports.
...
class IncidentType(str, enum.Enum):
    ...
    SCAFFOLDING_COLLAPSE = "scaffolding_collapse"
    EQUIPMENT_ACCIDENT = "equipment_accident"
    CRANE_INCIDENT = "crane_incident"
    ELECTRICAL_INCIDENT = "electrical_incident"
