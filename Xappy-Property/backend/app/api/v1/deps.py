...
# Pre-configured role dependencies - Construction
...
# Pre-configured role dependencies - Property Management
...
# Property management access (any PM-related role)
require_property_access = require_role([
    UserRole.LANDLORD,
    UserRole.PROPERTY_MANAGER,
    UserRole.AGENT,
    UserRole.SUPPLIER,
