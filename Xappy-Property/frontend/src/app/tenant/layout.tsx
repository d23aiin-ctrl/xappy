...
const navItems = [
  ...
  { name: "Application", href: "/tenant/application", icon: FileText },
  { name: "Documents", href: "/tenant/documents", icon: Upload },
  { name: "My Tenancy", href: "/tenant/tenancy", icon: Home },
  { name: "Report Issue", href: "/tenant/issues", icon: Wrench },
  { name: "Help & Support", href: "/tenant/help", icon: HelpCircle },
...
export default function TenantLayout({
  ...
  const getPageTitle = () => {
    ...
    return item?.name || "Tenant Portal";
  };
      ...
      <div className="lg:pl-64">
        ...
        <header className="sticky top-0 z-30 bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="hidden sm:flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition">
