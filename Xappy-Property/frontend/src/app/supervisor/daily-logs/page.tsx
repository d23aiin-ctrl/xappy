  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Daily Site Logs</h1>
          <p className="text-gray-600 mt-1">Daily progress updates, manpower records, and site observations</p>
        </div>
      ...
      {logs.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border p-12 text-center">
          ...
          <p className="text-gray-500 mt-2">Daily site logs will appear here when submitted via Chat Assistant.</p>
        </div>
      ) : (
