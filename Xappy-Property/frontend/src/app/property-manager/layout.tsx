...
const navItems = [
  { name: "Dashboard", href: "/property-manager/overview", icon: LayoutDashboard },
  { name: "Properties", href: "/property-manager/properties", icon: Home },
  { name: "Tenant Pipeline", href: "/property-manager/tenants", icon: Users },
  { name: "Maintenance", href: "/property-manager/maintenance", icon: Wrench },
  { name: "Compliance", href: "/property-manager/compliance", icon: Shield },
  { name: "Costs", href: "/property-manager/costs", icon: Receipt },
  { name: "Contracts", href: "/property-manager/contracts", icon: FileSignature },
  { name: "Help & Support", href: "/property-manager/help", icon: HelpCircle },
...
export default function PropertyManagerLayout({
  ...
  useEffect(() => {
    ...
    if (userData) {
      ...
      // Allow property management roles AND legacy supervisor/admin for now
      const allowedRoles = [
        "property_manager", "admin", "super_admin", "landlord", "agent",
        "supervisor", "site_manager" // Allow legacy roles for transition
      ];
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
            <Link href="/property-manager/overview" className="flex items-center space-x-2">
            ...
            <div className="flex items-center mb-3">
              ...
              <div className="ml-3 flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 capitalize truncate">
                  {user?.role?.replace("_", " ") || "Property Manager"}
                </p>
              </div>
      ...
      <div className="lg:pl-64">
        ...
        <header className="sticky top-0 z-30 bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Quick actions */}
            <button className="hidden sm:flex items-center px-3 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition">
              + Add Property
            </button>
          </div>
        </header>
