...
const DEMO_ACCOUNTS = [
  { badge: "SUP-2001", role: "Supervisor", name: "Supervisor One", icon: Building2, color: "text-blue-600 bg-blue-50 border-blue-200 hover:bg-blue-100" },
  { badge: "HSE-3001", role: "HSE Manager", name: "HSE Manager One", icon: ShieldCheck, color: "text-emerald-600 bg-emerald-50 border-emerald-200 hover:bg-emerald-100" },
  { badge: "CMP-4001", role: "Compliance", name: "Compliance One", icon: ClipboardCheck, color: "text-amber-600 bg-amber-50 border-amber-200 hover:bg-amber-100" },
  { badge: "ADM-9001", role: "Admin", name: "Admin One", icon: UserCog, color: "text-purple-600 bg-purple-50 border-purple-200 hover:bg-purple-100" },
];
...
const getRedirectUrl = (role: string): string => {
  switch (role) {
    ...
    case "property_manager":
      return "/property-manager/overview";
    case "landlord":
    ...
    case "agent":
      return "/property-manager/tenants";
    // Legacy construction roles
    case "hse_manager":
    case "hse_officer":
...
export default function LoginPage() {
  ...
  const handleBadgeLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiFetch("/api/v1/auth/badge-login", {
        method: "POST",
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const response = await apiFetch("/api/v1/auth/otp/send", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden flex items-center justify-center">
          ...
          {method === "badge" ? (
            <form onSubmit={handleBadgeLogin} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="input-glow w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 transition-all duration-300"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="input-glow w-full pl-12 pr-12 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 transition-all duration-300"
              ...
              <button
                type="submit"
                disabled={loading}
                className="btn-press ripple group w-full flex items-center justify-center gap-2 py-4 px-6 rounded-2xl text-white font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 shadow-xl shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed glow-breathe"
              >
                {loading ? (
                  <>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="input-glow w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
                ...
                <div className="space-y-2 animate-scale-in">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="input-glow w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 transition-all duration-300 tracking-[0.5em] text-center font-mono text-lg"
                      placeholder="••••••"
                      maxLength={6}
                      required
                    />
      ...
      {/* Decorative Elements */}
      <div className="absolute bottom-8 left-8 w-24 h-24 bg-gradient-to-br from-blue-400/30 to-indigo-600/30 rounded-2xl blur-xl animate-float-smooth morph-blob" />
      <div className="absolute top-1/4 right-8 w-16 h-16 bg-gradient-to-br from-amber-400/30 to-orange-500/30 rounded-xl blur-lg parallax-float" />
      <div className="absolute top-1/3 left-1/4 w-12 h-12 bg-gradient-to-br from-emerald-400/20 to-teal-500/20 rounded-full blur-lg animate-float-smooth" style={{ animationDelay: "-3s" }} />
    </div>
  );
}
