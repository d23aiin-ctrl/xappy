...
CONTEXT_MAP = {
    ReportType.NEAR_MISS.value: ConversationContext.NEAR_MISS_FILING,
    ReportType.INCIDENT.value: ConversationContext.INCIDENT_FILING,
    ReportType.DAILY_SAFETY_LOG.value: ConversationContext.DAILY_LOG_FILING,
    ...
    ReportType.PTW_EVIDENCE.value: ConversationContext.PTW_EVIDENCE,
    ReportType.LOTO_EVIDENCE.value: ConversationContext.LOTO_EVIDENCE,
    ReportType.SPILL_REPORT.value: ConversationContext.SPILL_REPORT,
    ReportType.INSPECTION.value: ConversationContext.INSPECTION,
}
