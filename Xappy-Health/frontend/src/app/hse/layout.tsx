...
export default function HSELayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-teal-800 to-teal-700 shadow-lg transform transition-transform duration-200 ease-in-out lg:translate-x-0 ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-4 border-b border-teal-600">
            <Link href="/hse/overview" className="flex items-center space-x-2">
              ...
              <div>
                ...
                <span className="block text-xs text-teal-200">HSE Dashboard</span>
              </div>
            </Link>
            <button
              className="lg:hidden"
          ...
          <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
            ...
            <div className="pt-4 mt-4 border-t border-teal-600">
              <Link
                ...
                className="flex items-center px-4 py-2.5 text-sm font-medium text-teal-200 rounded-lg hover:bg-teal-600 transition"
              >
          ...
          <div className="border-t border-teal-600 p-4">
            ...
            <button
              ...
              className="flex items-center w-full px-4 py-2 text-sm font-medium text-teal-100 rounded-lg hover:bg-teal-600 transition"
            >
