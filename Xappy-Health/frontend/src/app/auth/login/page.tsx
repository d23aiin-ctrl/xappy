...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden flex items-center justify-center">
      ...
      <button
        onClick={() => router.push("/")}
        className={`absolute top-6 left-6 flex items-center gap-2 text-slate-600 hover:text-teal-600 transition-all duration-300 group ${
      ...
      <div className={`w-full max-w-md px-6 transition-all duration-1000 ease-out ${
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-2xl overflow-hidden mb-6 shadow-xl shadow-teal-500/20 animate-glow-pulse">
            <Image
              src="/logo.png"
              alt="Xappy"
              width={96}
          ...
          {method === "badge" ? (
            <form onSubmit={handleBadgeLogin} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="group w-full flex items-center justify-center gap-2 py-4 px-6 rounded-xl text-white font-semibold haptik-gradient shadow-lg shadow-teal-500/25 hover:shadow-teal-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                {loading ? (
                  <>
            ...
            >
              ...
              {otpSent && (
                <button
                  ...
                  className="w-full text-sm text-slate-500 hover:text-teal-600 transition-colors py-2"
                >
                  Change phone number
                </button>
              )}
      ...
      {/* Decorative Elements */}
      <div className="absolute bottom-8 left-8 w-24 h-24 bg-gradient-to-br from-teal-400/20 to-teal-600/20 rounded-2xl blur-xl animate-float" />
